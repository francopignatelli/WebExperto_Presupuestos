...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference("Lineitem.count") do
      post lineitems_url, params: { lineitem: { budget_id: @lineitem.budget_id, product_id: @lineitem.product_id, quantity: @lineitem.quantity } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { budget_id: @lineitem.budget_id, product_id: @lineitem.product_id, quantity: @lineitem.quantity } }
